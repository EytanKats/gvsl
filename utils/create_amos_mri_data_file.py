...
DATA_DIR = '/share/data_supergrover3/kats/data/amos/dataset_preprocessed_mri'
NUM_SUP_FILES = 30
NUM_FOLDS = 5
NUM_SUP_TRAIN_FILES = [24, 16, 8, 4]

OUTPUT_SSL_FILE_PATH = '/share/data_supergrover3/kats/data/amos/dataset_preprocessed_mri/annotations/ssl_240.json'
OUTPUT_SUP_TEST_FILE_PATH = '/share/data_supergrover3/kats/data/amos/dataset_preprocessed_mri/annotations/sup_test_30.json'
OUTPUT_SUP_TRAIN_FILE_PATH_TEMPLATE = '/share/data_supergrover3/kats/data/amos/dataset_preprocessed_mri/annotations/sup_train'
...
sup_train_indices = indices[:NUM_SUP_FILES]
sup_test_indices = indices[NUM_SUP_FILES:]
